  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
        ...
        <span style={{ fontFamily: 'Inter', fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.07em', color: 'var(--c-muted)' }}>
          Sonne
        </span>
      </div>

      <svg viewBox="0 0 200 110" style={{ width: '100%', height: 'auto', overflow: 'visible' }} aria-hidden="true">
        <line x1="10" y1="100" x2="190" y2="100" style={{ stroke: 'var(--c-arc-horizon)' }} strokeWidth="1" />
        <path d="M 10,100 A 90,90 0 0 1 190,100" fill="none" style={{ stroke: 'var(--c-arc-track)' }} strokeWidth="2" strokeLinecap="round" />
        {isAboveHorizon && (
          <path
        ...
        <text x="10" y="116" textAnchor="middle" fontFamily="Inter" fontSize="11" style={{ fill: 'var(--c-muted)' }}>
          {formatLocalTime(sunriseIso)}
        </text>
        <text x="190" y="116" textAnchor="middle" fontFamily="Inter" fontSize="11" style={{ fill: 'var(--c-muted)' }}>
          {formatLocalTime(sunsetIso)}
        </text>
      </svg>

      <p style={{ fontFamily: 'Inter', fontSize: 12, color: 'var(--c-muted)', textAlign: 'center', marginTop: 4, fontVariantNumeric: 'tabular-nums' }}>
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0, paddingTop: 8 }}>
        ...
        <p style={{ fontFamily: 'Inter', fontSize: 13, color: 'var(--c-muted)', marginTop: 2 }}>
          {dateStr}
        </p>
            ...
            {hourlySlice.map((timeStr, idx) => {
              ...
              return (
                <div key={timeStr} style={{ minWidth: 64, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '12px 10px', gap: 4 }}>
                  <span style={{ fontFamily: 'Inter', fontSize: 12, color: 'var(--c-muted)' }}>{label}</span>
